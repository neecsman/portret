...
var accordion = function accordion(truggersSelector, itemsSelector) {
  var btns = document.querySelectorAll(truggersSelector);
...
var drop = function drop() {
  ...
  ['dragenter', 'dragleave', 'dragpver', 'drop'].forEach(function (eventName) {
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      markmLovers = wrapper.querySelectorAll('.lovers'),
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      uppload = document.querySelectorAll('[name="upload"]'); //checkNumInputs('input[name = "user_phone"]');
